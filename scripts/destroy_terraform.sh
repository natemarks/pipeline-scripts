...
usage() {
  cat <<EOF
Usage: destroy_terraform.sh [-h] [-v] -t tf_module

Change directory to the terraform module directory, run terraform destroy. Finally change back to the original directory
