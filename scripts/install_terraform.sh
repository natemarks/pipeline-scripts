...
Downloads and extracts terraform to the [directory/version].  Echoes the PATH update export command
...
-d  --directory   directory to download and extract terraform
EOF
  exit
}
